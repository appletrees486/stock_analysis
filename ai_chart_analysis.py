...

{
  ...
  "핵심기술적지표": {
    "이동평균선정배열": "예/아니오. 주가가 이동평균선들 위에 위치하며 정배열을 유지하고 있는지, 또는 역배열로 전환되었는지 상세히 설명",
    "골든데드크로스": "예/아니오. 최근 골든크로스나 데드크로스 발생 여부와 그 의미를 상세히 설명",
    "Stochastic상태": "%K vs %D 값과 과매수/과매도 구간 진입 여부, 모멘텀 강도 등을 상세히 분석",
    "볼린저밴드": "밴드 폭 변화, 현재가 위치, 변동성 확대/축소 여부 등을 상세히 분석"
  },
  "세부분석": {
    "가격및거래량": {
...

{
  ...
  "핵심기술적지표": {
    "장기정배열": "예/아니오. 주가가 장기 이동평균선들 위에 위치하며 정배열을 유지하고 있는지, 또는 역배열로 전환되었는지 상세히 설명",
    "CCI상태": "CCI 값과 과매수/과매도 구간 진입 여부, 모멘텀 방향 등을 상세히 분석",
    "ADX상태": "ADX 값과 추세 강도, 현재 추세 방향 등을 상세히 분석",
    "주요이동평균선": "5개월선, 10개월선, 20개월선 대비 현재가 위치와 각 선의 역할을 상세히 설명"
  },
  "세부분석": {
    "가격및거래량": {
      "거래량비교": "평균 대비 거래량",
