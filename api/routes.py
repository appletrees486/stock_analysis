...
def analyze_batch():
    ...
    try:
        ...
        logger.info(f"대량 분석 요청: 차트타입={chart_type}, 거래타입={trading_type}, 메일발송={email_enabled}")
        ...
        analyzer.start_batch_analysis(filepath, chart_type, batch_id, trading_type, email_enabled, email_address)
